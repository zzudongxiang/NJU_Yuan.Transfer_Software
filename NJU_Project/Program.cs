...
namespace NJU_Project
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            // 检查相关的DLL文件是否存在
            string[] DllList = new string[] { "GamePad.exe", "MTDevice.exe", "Library.dll", "SharpDX.DirectInput.dll", "SharpDX.dll" };
        ...
        /// 当前测试对象的目标
        /// </summary>
        public static Core TestCore { get; } = new Core();
