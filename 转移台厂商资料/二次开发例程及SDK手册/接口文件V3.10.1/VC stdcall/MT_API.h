...
MT_API INT32 /*__stdcall*/ MT_Open_UART2(char* sCOM);

MT_API INT32 /*__stdcall*/ MT_Close_UART2(void);

MT_API INT32 /*__stdcall*/ MT_Switch_To_UART(void);

MT_API INT32 /*__stdcall*/ MT_Switch_To_UART2(void);
